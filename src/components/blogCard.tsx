    ...
    return (
        <div className=' rounded-md shadow-lg border  dark:border-neutral-700 border-gray-300 p-3 bg-neutral-200 dark:bg-neutral-900'>
            ...
            <div className="relative group">
                <img src={blog.image} alt={blog.title} loading="eager" className='aspect-video transition-all duration-300  rounded-md bg-contain group-hover:blur-[2px]' />
            ...
            <p className='line-clamp-2 text-sm dark:text-gray-300 text-gray-700'>{blog.description}</p>
